...
class OpenSCARA {
    ...
    private:
        ...
        void homeAxis(AccelStepper axis, uint8_t endstopPin, uint8_t direction, double homingSpeed, float homingAcceleration, float movementSpeed, float movementAcceleration);
};